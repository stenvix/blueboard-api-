...
namespace BlueBoard.Module.Identity.Repositories
{
    internal class ParticipantRepository : IParticipantRepository
    {
        ...
        {
            var parameters = new {trip_id_in = tripId, user_id_in = userId};
        ...
        {
            var parameters = new {trip_id_in = tripId};
        ...
        public async Task<ParticipantEntity> GetAsync(IDbConnection connection, long tripId, long userId)
        {
            ...
            var participant = await connection.QueryFirstOrDefaultAsync<ParticipantEntity>(
                "find_participant_by_trip_and_user_v1", parameters, commandType: CommandType.StoredProcedure);
        ...
        public async Task<ParticipantEntity> CreateAsync(IDbConnection connection, ParticipantEntity entity)
        {
            var parameters = new
            {
                user_id_in = entity.UserId, trip_id_in = entity.TripId, created_by_in = entity.CreatedBy
            };
        ...
        public async Task RemoveAsync(IDbConnection connection, long id)
        {
            ...
            await connection.ExecuteAsync("remove_participant_v1", parameters,
                commandType: CommandType.StoredProcedure);
        }
    }
}
