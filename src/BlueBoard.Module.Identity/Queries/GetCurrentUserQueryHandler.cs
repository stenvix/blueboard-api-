...
{
    public class GetCurrentUserQueryHandler : IRequestHandler<GetCurrentUserQuery, ProfileModel>
    {
        ...
        public async Task<ProfileModel> Handle(GetCurrentUserQuery request, CancellationToken cancellationToken)
        {
